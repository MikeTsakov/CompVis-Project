...
class Scene3DRenderer
{
	...
	int m_morph_open_size;
	int m_morph_size;
	int m_hole_min_area;
	int m_hole_min_max_area;
	int m_d_threshold;
	...
	int m_custom_threshold;
	int m_pcustom_threshold;
...
public:
	...
	{
		return m_custom_threshold;
	}

	int getPCustomThreshold() const
	{
		return m_pcustom_threshold;
	}
	...
	void setPCustomThreshold(
		int pcustomThreshold)
	{
		m_pcustom_threshold = pcustomThreshold;
	}

	void setCustomThreshold(
		int threshold)
	{
		m_custom_threshold = threshold;
	}

	void setDThreshold(
		int threshold)
	{
		m_d_threshold = threshold;
	}
