...
public:
	...
	bool initialize();
	void initializeBGModel();

	bool m_thresholded;
	int m_shadow_threshold = 0;
	int m_variance_threshold = 0;
	int m_hole_threshold = 0;
	...
	void SetBSParameters(int shadowThreshold, int varThreshold);
	void GetForegroundFromBS(cv::InputArray frame, cv::OutputArray foreground);
