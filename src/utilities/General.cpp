...
const string General::ExtrinsicsVideo      = "extrinsics.avi";
const string General::ExtrinsicsImageFile  = "extrinsics.png";
...
const string General::VideoImageFile       = "video.png";
